            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="btn col-12" role="group" aria-label="Basic radio toggle button group">
                        ...
                        <label class="btn btn-outline-primary col-2" for="2" style="border: 1px solid orange;;"><br></label>
                        ...
                        <input type="radio" class="btn-check" name="btnradio" id="5" autocomplete="off">
